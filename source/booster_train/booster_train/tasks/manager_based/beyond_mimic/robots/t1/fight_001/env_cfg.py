...
class FlatEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.motion_file = f"{BOOSTER_ASSETS_DIR}/motions/T1/t1_fight_001_zfix.npz"
        self.commands.motion.anchor_body_name = "Trunk"
        self.commands.motion.body_names = [
            'Trunk',
            'H2',  # T1 head (equivalent to Head_2 in K1)
            'Hip_Roll_Left',  # T1 naming convention
            'Shank_Left',  # T1 naming convention
            'left_foot_link',
            'Hip_Roll_Right',  # T1 naming convention
            'Shank_Right',  # T1 naming convention
            'right_foot_link',
            'AL2',  # T1 left arm 2 (equivalent to Left_Arm_2 in K1)
            'AL3',  # T1 left arm 3 (equivalent to Left_Arm_3 in K1)
            'left_hand_link',
            'AR2',  # T1 right arm 2 (equivalent to Right_Arm_2 in K1)
            'AR3',  # T1 right arm 3 (equivalent to Right_Arm_3 in K1)
            'right_hand_link',
        ]
